...
fn bench_cbrt(c: &mut Criterion) {
    ...
    c.bench_function("std cbrt", |b| b.iter(|| {
        let input:[f32; 8] = black_box([12345.0; 8]);
        let mut out:[f32; 8] = [0.0; 8];
        for i in 0..8 {
            out[i] = input[i].cbrt();
    ...
    c.bench_function("jodie cos", |b| b.iter(|| {
        let input:[f32; 8] = black_box([12345.0; 8]);
        let mut out:[f32; 8] = [0.0; 8];
        for i in 0..8 {
            out[i] = cos(input[i]);
    ...
    c.bench_function("std cos", |b| b.iter(|| {
        let input:[f32; 8] = black_box([12345.0; 8]);
        let mut out:[f32; 8] = [0.0; 8];
        for i in 0..8 {
            out[i] = input[i].cos();
    ...
    c.bench_function("jodie log_2", |b| b.iter(|| {
        let input:[f32; 8] = black_box([12345.0; 8]);
        let mut out:[f32; 8] = [0.0; 8];
        for i in 0..8 {
            out[i] = log_2(input[i]);
    ...
    c.bench_function("std log_2", |b| b.iter(|| {
        let input:[f32; 8] = black_box([12345.0; 8]);
        let mut out:[f32; 8] = [0.0; 8];
        for i in 0..8 {
            out[i] = input[i].log2();
    ...
    c.bench_function("jodie sin", |b| b.iter(|| {
        let input:[f32; 8] = black_box([12345.0; 8]);
        let mut out:[f32; 8] = [0.0; 8];
        for i in 0..8 {
            out[i] = sin(input[i]);
